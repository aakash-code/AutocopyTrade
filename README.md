...
- **Web-Based UI:** A simple web dashboard (`app.py`) allows you to start and stop the trade replication engine from your browser.
...
- **Web UI:** The current UI is a functional prototype. It allows for starting and stopping the engine but does not include the advanced features from the user request (e.g., live order tables, detailed account dashboards, on-the-fly config changes).
